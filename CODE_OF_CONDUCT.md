...
**To report a possible violation, contact the maintainer at
`REPLACE-WITH-CONTACT-ADDRESS`.** This address is deliberately left as a marked
placeholder: the project owner has to set a real, monitored contact here before
this policy can be relied on, and inventing one would send reports nowhere. If
you are the owner, replace it with an email address (or a private reporting
route) and delete this paragraph.
...
This project uses the enforcement ladder below, which is the Contributor
Covenant's suggested remedy structure based on best practices in code of conduct
enforcement.
...
3. Temporary Suspension
   ...
   3. Repair: Examples of repair include respecting the spirit of the
      suspension, meeting the specified conditions, and being thoughtful about
      how to reintegrate into the community when the suspension is lifted.
4. Permanent Ban
